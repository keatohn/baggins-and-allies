...
wotr_1.1: prefers units.csv + terr.csv; falls back to legacy "Baggins & Allies - …" names.
"""
import csv
import json
import re
...
# Prefer short names in-repo; keep legacy spreadsheet export names as fallback.
UNITS_CSV_NAMES = ("units.csv", "Baggins & Allies - exp units csv.csv")
TERR_CSV_NAMES = ("terr.csv", "Baggins & Allies - exp terr csv.csv")
